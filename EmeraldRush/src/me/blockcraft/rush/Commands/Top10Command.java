...
public class Top10Command implements Listener, CommandExecutor {
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (args.length == 1) {
            if (args[0].equalsIgnoreCase("wins")) {
                p.sendMessage("\u00a77\u00a7m---------------------------------");
                try {
                    final ResultSet rs = MySQL.getResult("SELECT `WIN`,`NAME` FROM `em_stats` ORDER BY WIN DESC LIMIT 10;");
                    int zahl = 0;
                    while (rs.next()) {
                        if (++zahl == 1) {
                ...
                p.sendMessage("\u00a77\u00a7m---------------------------------");
                try {
                    final ResultSet rs = MySQL.getResult("SELECT `DEATHS`,`NAME` FROM `em_stats` ORDER BY DEATHS DESC LIMIT 10;");
                    int zahl = 0;
                    while (rs.next()) {
                        if (++zahl == 1) {
                            p.sendMessage("\u00a7e\u00a7l#1 " + ChatColor.GRAY + ChatColor.BLUE + rs.getString(2) + "\u00a77 ( " + ChatColor.WHITE + rs.getInt(1) + ChatColor.GRAY + " ) ");
                ...
                p.sendMessage("\u00a77\u00a7m---------------------------------");
                try {
                    final ResultSet rs = MySQL.getResult("SELECT `KILLS`,`NAME` FROM `em_stats` ORDER BY KILLS DESC LIMIT 10;");
                    int zahl = 0;
                    while (rs.next()) {
                        if (++zahl == 1) {
                            p.sendMessage("\u00a7e\u00a7l#1 " + ChatColor.GRAY + ChatColor.BLUE + rs.getString(2) + "\u00a77 ( " + ChatColor.WHITE + rs.getInt(1) + ChatColor.GRAY + " ) ");
                ...
                p.sendMessage("\u00a77\u00a7m---------------------------------");
                try {
                    final ResultSet rs = MySQL.getResult("SELECT `LOSE`,`NAME` FROM `em_stats` ORDER BY LOSE DESC LIMIT 10;");
                    int zahl = 0;
                    while (rs.next()) {
                        if (++zahl == 1) {
                            p.sendMessage("\u00a7e\u00a7l#1 " + ChatColor.GRAY + ChatColor.BLUE + rs.getString(2) + "\u00a77 ( " + ChatColor.WHITE + rs.getInt(1) + ChatColor.GRAY + " ) ");
                ...
                p.sendMessage("\u00a77\u00a7m---------------------------------");
                try {
                    final ResultSet rs = MySQL.getResult("SELECT `COINS`,`NAME` FROM `em_stats` ORDER BY COINS DESC LIMIT 10;");
                    int zahl = 0;
                    while (rs.next()) {
                        if (++zahl == 1) {
                            p.sendMessage("\u00a7e\u00a7l#1 " + ChatColor.GRAY + ChatColor.BLUE + rs.getString(2) + "\u00a77 ( " + ChatColor.WHITE + rs.getInt(1) + ChatColor.GRAY + " ) ");
